...
class HelpEmbeds:
    ...
    def help() -> Embed:
        ...
        embed = Embed(
            ...
            description="Statalytics is a Discord bot that provides a range of Bedwars related "
            + "functionality.\n\nFor indepth information on different aspects of"
            + "features, navigate using the buttons below.",
            color=config.embed_color("primary"),
        ).add_field(
            name="Resources",
            value="Documentation: https://docs.statalytics.net\n"
    ...
    def compare() -> Embed:
        ...
        embed = Embed(
            ...
            description="- The stat comparison feature allows you to compare the stats of two players."
            ...
            color=config.embed_color("primary"),
        ).add_field(name="**Commands:**", value="`/compare <player_1> [<player_2>]`")
        return embed
    ...
    def linking() -> Embed:
        ...
        embed = Embed(
            ...
            description="- Linking your account is a quality-of-life feature that offers several "
            ...
            color=config.embed_color("primary"),
        ).add_field(name="**Commands:**", value="`/link <player>`\n`/unlink`")
        return embed
    ...
    def projection() -> Embed:
        ...
        embed = Embed(
            ...
            description="- The Bedwars Stat Projection feature predicts your stats at any given "
    ...
    def rotational() -> Embed:
        ...
        embed = Embed(
            ...
            description="- The `/daily`, `/weekly`, `/monthly`, and `/yearly` commands show your "
    ...
    def settings() -> Embed:
        ...
        embed = Embed(
            ...
            + "is not configured",
            color=config.embed_color("primary"),
        ).add_field(name="**Commands:**", value="`/settings`")
        return embed
    ...
    def tracker_resetting() -> Embed:
        ...
        embed = (
            Embed(
                ...
                description="Hypixel API changes and growth require a new, efficient rotational stats "
            ...
            .add_field(
                ...
                value="Command execution by users triggers API calls that fetch player stats. This "
            ...
            .add_field(
                ...
                value="This method, now only available to [premium supporters](https://statalytics.net/"
