...
class PremiumEmbeds:
    ...
    def pro() -> Embed:
        ...
        embed.add_field(
            ...
            value=
                "- Auto Rotational Resets - rotational stats automatically rollover daily/weekly/etc.\n"
                ...
                "- Infinite Historical Lookback - view historical rotational stats with no limits.\n"
                "- Up to 5 Active Sessions - activate up to 5 sessions at one time."
        )
        embed.add_field(
    ...
    def basic() -> Embed:
        ...
        embed.add_field(
            ...
            value=
                "- Yearly Stats - view your own or another player's yearly rotational stats.\n"
                "- 2026 Stats - predict your own or another player's stats for the year 2026.\n"
                "- 60 Day Historical Lookback - view historical rotational stats with a 60 day limit.\n"
                "- Up to 3 Active Sessions - activate up to 3 sessions at one time."
        )
        embed.add_field(
            name="Customizability, ease of access, misc",
            value=
    ...
    def booster_premium() -> Embed:
        embed = Embed(
            title="<:boost1:1083184939056504874> Booster Perks <:boost1:1083184939056504874>",
            description=
