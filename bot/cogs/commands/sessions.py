...
class Sessions(commands.Cog):
    ...
    async def session(self, interaction: discord.Interaction, username: str=None, session: int=None):
        ...
        render_session(name, uuid, session, mode="Overall", hypixel_data=hypixel_data, skin_res=skin_res.content, save_dir=interaction.id)
        ...
        render_session(name, uuid, session, mode="Solos", hypixel_data=hypixel_data, skin_res=skin_res.content, save_dir=interaction.id)
        render_session(name, uuid, session, mode="Doubles", hypixel_data=hypixel_data, skin_res=skin_res.content, save_dir=interaction.id)
        render_session(name, uuid, session, mode="Threes", hypixel_data=hypixel_data, skin_res=skin_res.content, save_dir=interaction.id)
        render_session(name, uuid, session, mode="Fours", hypixel_data=hypixel_data, skin_res=skin_res.content, save_dir=interaction.id)
        render_session(name, uuid, session, mode="4v4", hypixel_data=hypixel_data, skin_res=skin_res.content, save_dir=interaction.id)
